...
import SliferGallery from "./SliferGallery";
import { useTranslation } from "react-i18next";

const TourDetailsRight = ({ infotour }: { infotour: any }) => {
              ...
              <div className="tour-details-wrapper">
                <div className="tour-details mb-25">
                  <div className="tour-details-thumb details-slide-full mb-30">
                    <SliferGallery gallery={infotour.tourinfo.galeria.nodes} />
                  </div>
                  <div className="tour-details-content">
                    ...
                    <h3 className="tour-details-title mb-15">{infotour.title}</h3>
                    <div className="tour-details-meta d-flex flex-wrap gap-10 align-items-center justify-content-between mb-20">
                      <div className="tour-details-price">
                        <h4 className="price-title">
                          ${infotour.tourinfo.precio}<span>/{t('priceperson')}</span>
                        </h4>
                      </div>
                    ...
                    {/*tab area start*/}
                    <TourDetailsRightTabArea data={infotour.tourinfo} />
                    {/*tab area end*/}
                    {/*tour area start*/}
                    <div className="tour-details-related-tour mb-35">
                      <h4 className="mb-20">{t('relatedtour')}</h4>
                      {/* <div className="row gy-24">
